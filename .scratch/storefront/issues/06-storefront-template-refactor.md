...
**What to build:** The dedicated Angonaloy storefront (`github.com/Angonaloy/angonaloy_storefront`, originally forked from the single-tenant `github.com/noorkarimmehedi/e-commerce` built for Stepprs Bangladesh) is the storefront that fetches all data from the Merchant-Suite public API based on a configurable handle, and renders the correct merchant's branding and products.
