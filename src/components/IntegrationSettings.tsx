...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "fb_verify_token", label: "Webhook Verify Token", placeholder: "any-secret-string-you-choose", hint: `Webhook URL: https://angonaloy-commerceos.vercel.app/api/webhooks/facebook` },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "fb_verify_token", label: "Webhook Verify Token", placeholder: "same-as-facebook", hint: `Uses the same webhook as Facebook: https://angonaloy-commerceos.vercel.app/api/webhooks/facebook` },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "wa_verify_token", label: "Webhook Verify Token", placeholder: "any-secret-string-you-choose", hint: `Webhook URL: https://angonaloy-commerceos.vercel.app/api/webhooks/whatsapp` },
    ],
  },
];
        ...
        <div className="space-y-5">
          ...
          <div className="overflow-hidden rounded-2xl bg-black/[0.04] p-5 space-y-3">
            ...
            <p className="text-[11px] text-black/30">
              Redirect URL to add in your Shopify app: <span className="font-mono select-all">https://angonaloy-commerceos.vercel.app/api/auth/shopify/callback</span>
            </p>
          </div>
